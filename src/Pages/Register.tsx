            ...
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-md-5 px-lg-4">
                        <div className="card">
                            <div className="card-header"><i className="fa fa-user"></i> Register Now</div>
                            <div className="card-body">
                                <div className="form-group">
                                    <label className="mt-3" htmlFor="">UserName</label>
                                    <input className="form-control" type="text" name="username" id="username" placeholder="User name" onChange={changeHandler}/>
                                </div>
                                <div className="form-group">
                                    <label className="mt-3" htmlFor="Phone">Phone</label>
                                    <input className="form-control" type="phone" name="phone" id="phone" placeholder="Phone" onChange={changeHandler}/>
                                </div>
                                <div className="form-group">
                                ...
                                <div className="form-group my-3">
                                    <button className="btn btn-primary px-5" onClick={submitForm}>Register</button>
                                </div>
                            </div>
                            <div className="card-footer">
                                <div className="pull-right">
                                    Already Register <NavLink to='/login' className='text-decoration-none'><i className="fa fa-lock"></i> Login Now</NavLink>
                                </div>
                            </div>
                        </div>
                    </div>
